...
async function testGeminiAgent() {
    ...
    const repsonse3 = await agent.processQuery("check the balance of 0x8a0951ea5FF7569eA6455E6362D322dd576309C9 and if it is greater than 0.03 eth  send 0.01 eth");
